...
sops -d sops-age.cho.yaml | kubectl apply --server-side --filename -
sops -d ../flux/vars/cluster-secrets.cho.yaml | kubectl apply --server-side --filename -
sops -d ./github-deploy-key.cho.yaml| kubectl apply --server-side --filename -
